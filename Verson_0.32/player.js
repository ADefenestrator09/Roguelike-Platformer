class Player{
  ...
  update(gravity,jumpPressed,dashPressed,platforms){
    ...
    //moving the camera based off player movement
    let offsetX = width/2 - this.pos.x;
    let offsetY = height/2 - this.pos.y;
    
    //I want to make something for the camera moving in a way that I don't see the underworld. I also want to have it so that the camera moves up when high enough.
    offsetY = constrain(offsetY, height-400,0);
