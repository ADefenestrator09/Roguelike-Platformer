...
function draw() {
  if(!start && !dead && !levelSelector && !win){
    ...
    if(keyIsDown(80) && rCooldown == 0 && buildMode == 0 && build){
      pHeight = 20;
      pWidth = 100;
      c = [0,220,70];
      ...
      buildMode = 1;
      isObjective = false;
    } if(keyIsDown(80) && rCooldown == 0 && buildMode == 1 && build){ //p to cycle through platform types
      pHeight = 15;
      pWidth = 15;
      c = [100,100,100];
      rCooldown = COOLDOWNMAX
      ...
      buildMode = 2;
      isObjective = false;
    } if(keyIsDown(80) && rCooldown == 0 && buildMode == 2 && build){
      pHeight = 20;
      pWidth = 100;
      c = [255,100,100];
      rCooldown = COOLDOWNMAX;
    ...
    } if(keyIsDown(80) && rCooldown == 0 && buildMode == 3 && build){
      pHeight = 20;
      pWidth = 20;
      c = [0,255,0];
      rCooldown = COOLDOWNMAX;
  ...
  } else if(levelSelector && !win && !dead){
    background(135, 206, 235);
    stroke(0);
    fill(0);
    textSize(50);
